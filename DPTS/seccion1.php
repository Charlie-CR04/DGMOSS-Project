            ...
            <div class="col-lg-10">
                <div class="objetivo-container">
                    ...
                    <p>
                        ...
                        y organizacionales que permitan una valoración integral de las tecnologías para la salud. Todo esto con el propósito de optimizar 
                        el uso eficiente de los recursos disponibles y contribuir a la mejora continua de la atención a la salud dentro del Sistema Nacional de Salud.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center align-items-start">
            ...
            <div class="col-lg-4 col-md-5 mb-4">
                <div class="director-container text-center">
                    <figure class="mb-4">
                        <img src="/dgmoss/assets/img/Directores/4.png" 
                    ...
                    <div class="contacto-card-body">
                        <div class="contacto-item">
                            ...
                            <div>
                                ...
                                <span class="contacto-value">6392-2300 Ext. 52422</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-10">
                    <div class="organigrama-container">
                        <h3 class="sub-title mb-3 text-center">Colaboradores</h3>
                            <img src="/dgmoss/assets/img/organigramas/organigrama_politicas.png" 
