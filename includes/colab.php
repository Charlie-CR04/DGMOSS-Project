                ...
                <div class="row ro-cols-2 row-cols-md-4 g-4 align-items-center">
                    ...
                    <div class="col text-center">
                        <a href="https://pesquisa.bvsalud.org/brisa/resource/es/biblio-1577700#" target="_blank" rel="noopener noreferrer">
                            <img src="/dgmoss-project/assets/img/colabs/brisa.png" alt="BRISA" class="colab-icon img-fluid BRISA">
                        </a>
                    </div>
                    ...
                    <div class="col text-center">
                        <a href="https://www.cdc.gov/" target="_blank" rel="noopener noreferrer">
                            <img src="/dgmoss-project/assets/img/colabs/CDN.png" alt="CDC" class="colab-icon img-fluid CDC">
                        </a>
                    </div>

                    <div class="col text-center">
                        <a href="https://redetsa.bvsalud.org/" target="_blank" rel="noopener noreferrer">
                            <img src="/dgmoss-project/assets/img/colabs/RedETSA.png" alt="REDETSA" class="colab-icon img-fluid REDETSA">
                        </a>
                    </div>
                </div>
            </div>
