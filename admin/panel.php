                ...
                <?php if ($isAdmin): ?>
                    ...
                    <div class="col-4 d-flex tarjet">
                        <a href="/dgmoss-project/admin/direcciones/direcciones.php" class="text-decoration-none text-black">
                            <img src="/dgmoss-project/assets/img/banners/1.png" alt="Panel direcciones" class="img-fluid">
                    ...
                    <?php if ($puedeVerCategorias): ?>
                        <div class="col-4 d-flex tarjet">
                            <a href="/dgmoss-project/admin/categorias/index_admin.php" class="text-decoration-none text-black">
                                <img src="/dgmoss-project/assets/img/banners/5.png" alt="Panel categorías" class="img-fluid">
                ...
                <?php else: ?>
                    ...
                    <div class="col-6 d-flex tarjet">
                        <a href="/dgmoss-project/admin/direcciones/editores.php" class="text-decoration-none text-black">
                            <img src="/dgmoss-project/assets/img/banners/4.png" alt="Mis documentos" class="img-fluid">
